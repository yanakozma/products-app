...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-blue-40 bg-white text-black px-3 py-2 text-sm shadow-sm ring-offset-2 placeholder:text-black focus:outline-none focus:ring-2 focus:ring-blue-10 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
            className
        )}
        {...props}
    >
        ...
        <SelectPrimitive.Icon asChild>
            <ChevronDown className="h-4 w-4 text-blue-40 opacity-50" />
